...
/**
 * <b>MessageUser est la classe exceptionnelle qui permet de standardiser les échanges multicast.</b>
...
public class MessageUser implements Serializable {
	 ...
	 */
	public MessageUser(String pseudo, InetAddress iP, int port,int portFile, typeConnect etat) {
		this.pseudo = pseudo;
		IP = iP;
		this.port = port;
		this.etat=etat;
